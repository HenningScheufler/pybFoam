...
void bindDict(nanobind::module_ &m)
{
    ...
    nb::class_<Foam::dictionary>(m, "dictionary")
        ...
        .def("set", &Foam::set<bool>)          // bool MUST come before scalar (bool is subtype of float in Python)
        ...
        .def("set", &Foam::set<Foam::List<Foam::label>>)
        .def("set", [](Foam::dictionary &self, const std::string key, const Foam::dictionary& subDict)
             { self.set(Foam::word(key), subDict); })
