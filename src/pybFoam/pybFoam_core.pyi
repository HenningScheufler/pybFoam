...
class IOobject:
    class readOption:
        ...
        READ_IF_PRESENT: typing.ClassVar[
            IOobject.readOption
        ]  # value = <readOption.READ_IF_PRESENT: 4>
        __members__: typing.ClassVar[
            dict[str, IOobject.readOption]
        ]  # value = {'NO_READ': NO_READ, 'MUST_READ': <readOption.MUST_READ: 1>, 'READ_IF_PRESENT': <readOption.READ_IF_PRESENT: 4>}
    ...
    class writeOption:
        ...
        __members__: typing.ClassVar[
            dict[str, IOobject.writeOption]
        ]  # value = {'NO_WRITE': NO_WRITE, 'AUTO_WRITE': <writeOption.AUTO_WRITE: 16>}
        def __eq__(self, other: typing.Any) -> bool: ...
        def __getstate__(self) -> int: ...
        def __hash__(self) -> int: ...
        def __index__(self) -> int: ...
    ...
    def __init__(
        ...
        instance: fileName,
        registry: Time,
        readOpt: IOobject.readOption = NO_READ,
        writeOpt: IOobject.writeOption = NO_WRITE,
    ) -> None: ...
...
class dimensionedScalar:
    ...
    @typing.overload
    def __init__(
        self, name: Word, dimensions: dimensionSet, value: typing.SupportsFloat
    ) -> None: ...
    @typing.overload
    def __init__(self, name: Word, dimensions: dimensionSet, dict: dictionary) -> None: ...
    @typing.overload
    def __init__(
        self, name: str, dimensions: dimensionSet, value: typing.SupportsFloat
    ) -> None: ...
    @typing.overload
...
class faceList:
    ...
    @typing.overload
    def __init__(
        self, faces: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]
    ) -> None: ...
...
class fvScalarMatrix:
    ...
    def relax(self) -> None: ...
    def setReference(
        self, arg0: typing.SupportsInt, arg1: typing.SupportsFloat, arg2: bool
    ) -> None: ...
    @typing.overload
    def solve(self) -> None: ...
    @typing.overload
...
class polyMesh:
    ...
    def __init__(
        self,
        io: IOobject,
        points: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]],
        faces: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]],
        owner: collections.abc.Sequence[typing.SupportsInt],
        neighbour: collections.abc.Sequence[typing.SupportsInt],
        syncPar: bool = True,
    ) -> None:
        """
    ...
    def __init__(
        ...
        io: IOobject,
        points: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat]],
        cells: collections.abc.Sequence[tuple[str, collections.abc.Sequence[typing.SupportsInt]]],
        boundaryPatches: collections.abc.Sequence[
            tuple[str, collections.abc.Sequence[collections.abc.Sequence[typing.SupportsInt]]]
        ],
        defaultPatchName: str = "defaultFaces",
        syncPar: bool = True,
    ) -> None:
        """
        ...
        """
    def addPatches(
        self, patches: collections.abc.Sequence[polyPatch], validBoundary: bool = True
    ) -> None: ...
...
class symmTensor:
    ...
    @typing.overload
    def __init__(
        self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(6)"]
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class tensor:
    ...
    @typing.overload
    def __init__(
        self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(9)"]
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        ...
        arg5: typing.SupportsFloat,
        arg6: typing.SupportsFloat,
        arg7: typing.SupportsFloat,
        arg8: typing.SupportsFloat,
    ) -> None: ...
    def __len__(self) -> int: ...
...
class vector:
    ...
    @typing.overload
    def __init__(
        self, arg0: typing.Annotated[collections.abc.Sequence[typing.SupportsFloat], "FixedSize(3)"]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, arg0: typing.SupportsFloat, arg1: typing.SupportsFloat, arg2: typing.SupportsFloat
    ) -> None: ...
    def __len__(self) -> int: ...
...
def constrainHbyA(
    arg0: tmp_volVectorField, arg1: volVectorField, arg2: volScalarField
) -> tmp_volVectorField: ...
@typing.overload
def constrainPressure(
    p: volScalarField, U: volVectorField, phiHbyA: surfaceScalarField, rAU: volScalarField
) -> None: ...
@typing.overload
def constrainPressure(
    p: volScalarField, U: volVectorField, phiHbyA: surfaceScalarField, rAU: surfaceScalarField
) -> None: ...
...
def setRefCell(
    p: volScalarField, dict: dictionary, forceReference: bool = False
) -> tuple[int, float]: ...
@typing.overload
