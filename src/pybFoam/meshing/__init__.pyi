...
@typing.overload
def checkGeometry(
    mesh: pybFoam.pybFoam_core.polyMesh, all_geometry: bool = False
) -> dict[str, typing.Any]:
    """
...
@typing.overload
def checkGeometry(
    mesh: pybFoam.pybFoam_core.fvMesh, all_geometry: bool = False
) -> dict[str, typing.Any]:
    """
    Check mesh geometry and return dictionary with results
    """
...
@typing.overload
def checkMesh(
    mesh: pybFoam.pybFoam_core.polyMesh,
...
@typing.overload
def checkTopology(
    mesh: pybFoam.pybFoam_core.polyMesh, all_topology: bool = False, all_geometry: bool = False
) -> dict[str, typing.Any]:
    """
...
@typing.overload
def checkTopology(
    mesh: pybFoam.pybFoam_core.fvMesh, all_topology: bool = False, all_geometry: bool = False
) -> dict[str, typing.Any]:
    """
    Check mesh topology and return dictionary with results
    """
...
def generate_blockmesh(
    runtime: pybFoam.pybFoam_core.Time,
    blockmesh_dict: pybFoam.pybFoam_core.dictionary,
    verbose: bool = False,
    time_name: str = "constant",
) -> pybFoam.pybFoam_core.fvMesh:
    """
...
@typing.overload
def printMeshStats(
    mesh: pybFoam.pybFoam_core.polyMesh, all_topology: bool = False
) -> dict[str, typing.Any]:
    """
...
@typing.overload
def printMeshStats(
    mesh: pybFoam.pybFoam_core.fvMesh, all_topology: bool = False
) -> dict[str, typing.Any]:
    """
    Print mesh statistics and return as dictionary
    """
